...
func TestPaginationParamsLimit(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "legacy max value keeps", pageSize: 1000, want: 1000},
		{name: "new max value keeps", pageSize: 2000, want: 2000},
		{name: "beyond max clamps to 2000", pageSize: 2500, want: 2000},
	}
...
func TestPaginationParamsOffsetUsesNormalizedLimit(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "page size beyond max is clamped", page: 2, pageSize: 2500, want: 2000},
	}
