...
func TestHandleNonStreamingResponse_NonJSON2xxTriggersFailover(t *testing.T) {
	...
	usage, auditBody, err := svc.handleNonStreamingResponse(context.Background(), resp, c, &Account{ID: 1}, "claude-sonnet-4-6", "claude-sonnet-4-6")
...
func TestHandleNonStreamingResponse_ValidJSONUnchanged(t *testing.T) {
	...
	require.JSONEq(t, string(body), string(auditBody))
...
func TestHandleNonStreamingResponseAnthropicAPIKeyPassthrough_NonJSON2xxTriggersFailover(t *testing.T) {
	...
	usage, auditBody, err := svc.handleNonStreamingResponseAnthropicAPIKeyPassthrough(context.Background(), resp, c, &Account{ID: 2})
