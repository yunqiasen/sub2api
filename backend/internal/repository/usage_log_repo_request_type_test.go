...
func TestPrepareUsageLogInsert_PersistsImageSizeMetadata(t *testing.T) {
	...
	require.Equal(t, sql.NullString{String: imageSize, Valid: true}, prepared.args[52])
	require.Equal(t, sql.NullString{String: inputSize, Valid: true}, prepared.args[53])
	require.Equal(t, sql.NullString{String: outputSize, Valid: true}, prepared.args[54])
	require.Equal(t, sql.NullString{String: source, Valid: true}, prepared.args[55])
	breakdownJSON, ok := prepared.args[56].(string)
	require.True(t, ok)
