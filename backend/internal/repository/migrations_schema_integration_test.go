...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "usage_logs", "request_prompt", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "system_prompt_summary", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "system_prompt_text", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "developer_prompt_text", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "tool_names", "jsonb", 0, true)
	requireColumn(t, tx, "usage_logs", "tool_call_names", "jsonb", 0, true)
	requireColumn(t, tx, "usage_logs", "tool_calls_json", "jsonb", 0, true)
	requireColumn(t, tx, "usage_logs", "output_summary", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "output_text", "text", 0, true)
	requireColumn(t, tx, "usage_logs", "request_body_sha256", "character varying", 64, true)
	requireColumn(t, tx, "usage_logs", "request_body_bytes", "integer", 0, true)
	requireColumn(t, tx, "usage_logs", "request_body_truncated", "boolean", 0, false)
	requireColumn(t, tx, "usage_logs", "response_text_truncated", "boolean", 0, false)
	requireColumn(t, tx, "usage_logs", "turn_metadata", "jsonb", 0, true)
	requireColumn(t, tx, "usage_logs", "ip_location", "jsonb", 0, true)
	requireColumn(t, tx, "usage_logs", "audit_capture_version", "smallint", 0, false)
	requireIndex(t, tx, "usage_logs", "usage_logs_request_body_sha256_idx")
	requireColumn(t, tx, "ops_error_logs", "request_prompt", "text", 0, true)
	requireColumn(t, tx, "ops_error_logs", "system_prompt_summary", "text", 0, true)
	requireColumn(t, tx, "ops_error_logs", "system_prompt_text", "text", 0, true)
	requireColumn(t, tx, "ops_error_logs", "developer_prompt_text", "text", 0, true)
	requireColumn(t, tx, "ops_error_logs", "tool_names", "jsonb", 0, true)
	requireColumn(t, tx, "ops_error_logs", "tool_call_names", "jsonb", 0, true)
	requireColumn(t, tx, "ops_error_logs", "output_summary", "text", 0, true)
	requireColumn(t, tx, "ops_error_logs", "request_body_sha256", "character varying", 64, true)
	requireColumn(t, tx, "ops_error_logs", "request_body_bytes", "integer", 0, true)
	requireColumn(t, tx, "ops_error_logs", "request_body_truncated", "boolean", 0, false)
	requireColumn(t, tx, "ops_error_logs", "turn_metadata", "jsonb", 0, true)
	requireColumn(t, tx, "ops_error_logs", "ip_location", "jsonb", 0, true)
	requireColumn(t, tx, "ops_error_logs", "audit_capture_version", "smallint", 0, false)
	requireIndex(t, tx, "ops_error_logs", "ops_error_logs_request_body_sha256_idx")
