...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldToolNames, usagelog.FieldToolCallNames, usagelog.FieldToolCallsJSON, usagelog.FieldTurnMetadata, usagelog.FieldIPLocation, usagelog.FieldImageSizeBreakdown:
			values[i] = new([]byte)
		case usagelog.FieldRequestBodyTruncated, usagelog.FieldResponseTextTruncated, usagelog.FieldUpstreamModelMismatch, usagelog.FieldLongContextBillingApplied, usagelog.FieldStream, usagelog.FieldCacheTTLOverridden:
