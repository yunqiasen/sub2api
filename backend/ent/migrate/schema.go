...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "request_prompt", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "system_prompt_summary", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "system_prompt_text", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "developer_prompt_text", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "tool_names", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "tool_call_names", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "tool_calls_json", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "output_summary", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "output_text", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "request_body_sha256", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "request_body_bytes", Type: field.TypeInt, Nullable: true},
		{Name: "request_body_truncated", Type: field.TypeBool, Default: false},
		{Name: "response_text_truncated", Type: field.TypeBool, Default: false},
		{Name: "turn_metadata", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "ip_location", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "audit_capture_version", Type: field.TypeInt16, Default: 1},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_request_body_sha256",
				Unique:  false,
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[62], UsageLogsColumns[58]},
			},
			{
				Name:    "usagelog_api_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[59], UsageLogsColumns[58]},
			},
			{
				Name:    "usagelog_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[61], UsageLogsColumns[58]},
			},
		},
	}
