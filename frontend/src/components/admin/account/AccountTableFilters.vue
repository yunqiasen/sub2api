...
const sOpts = computed(() => [
  ...
  { value: 'error', label: t('admin.accounts.status.errorAuthInvalid') },
  { value: 'error_network', label: t('admin.accounts.status.errorNetwork') },
  { value: 'error_cf', label: t('admin.accounts.status.errorCF') },
  { value: 'error_other', label: t('admin.accounts.status.errorOther') },
