  ...
  admin: {
    ...
    accounts: {
      ...
      status: {
        ...
        inactive: '停用',
        error: '错误',
        errorAuthInvalid: '凭证失效',
        errorNetwork: 'EOF / 网络错误',
        errorCF: '403 / CF',
        errorOther: '其它错误',
        cooldown: '冷却中',
        paused: '暂停',
      ...
      bulkDeleteGroupSelectRequired: '请先选择一个具体分组',
      bulkDeleteGroupPrompt: '将删除分组「{name}」下全部 {count} 个账号，不会删除未绑定该分组的账号。请输入分组名确认：{name}',
      bulkDeleteGroupSuccess: '已删除分组「{name}」下 {count} 个账号',
      bulkDeleteGroupPartial: '分组「{name}」删除部分完成：成功 {success} 个，失败 {failed} 个',
      bulkDeleteGroupFailed: '删除分组账号失败',
      bulkDeleteGroupNoAccounts: '分组「{name}」下没有账号',
      recoverState: '恢复状态',
    ...
    usage: {
      ...
      details: '详情',
      statusCode: '状态码',
      systemPromptShort: '系统词',
      actualTools: '实际工具',
      basicInfo: '基础信息',
      systemPrompt: 'System 提示词',
      developerPrompt: 'Developer 提示词',
      systemPromptSummary: '系统词摘要',
      outputSummary: '输出摘要',
      requestBodyHash: '请求体 Hash',
      requestBodyBytes: '请求体大小',
      requestBodyTruncated: '请求体截断',
      responseTextTruncated: '响应截断',
      truncated: '截断状态',
      tools: '工具',
      availableTools: '可用工具',
      toolNames: '工具名',
