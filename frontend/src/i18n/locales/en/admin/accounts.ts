export default {
    accounts: {
        ...
        bulkDeleteGroupNoAccounts: "No accounts in {name}",
        bulkDeleteGroupPartial: "{name}: {success} succeeded, {failed} failed",
        bulkDeleteGroupPrompt: "Delete all {count} accounts in {name}. Type the group name to confirm",
        bulkDeleteGroupSelectRequired: "Select a group first",
        bulkDeleteGroupSuccess: "Deleted {count} accounts from {name}",
      ...
      bulkActions: {
        ...
        deleteCurrentGroup: "Delete all group accounts",
