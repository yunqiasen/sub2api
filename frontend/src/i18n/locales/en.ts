  ...
  admin: {
    ...
    accounts: {
      ...
      status: {
        ...
        inactive: 'Inactive',
        error: 'Error',
        errorAuthInvalid: 'Invalid Credentials',
        errorNetwork: 'EOF / Network Error',
        errorCF: '403 / CF',
      ...
      bulkActions: {
        ...
        selectGroupToDelete: 'Select group to delete all',
      ...
      bulkDeleteGroupSelectRequired: 'Select one concrete group first',
      bulkDeleteGroupPrompt: 'This will delete all {count} account(s) bound to group "{name}". Accounts outside this group are not deleted. Type the group name to confirm: {name}',
      bulkDeleteGroupSuccess: 'Deleted {count} account(s) from group "{name}"',
      bulkDeleteGroupPartial: 'Group "{name}" delete partially completed: {success} succeeded, {failed} failed',
      bulkDeleteGroupFailed: 'Failed to delete group accounts',
      bulkDeleteGroupNoAccounts: 'Group "{name}" has no accounts',
    ...
    usage: {
      ...
      details: 'Details',
      statusCode: 'Status',
      systemPromptShort: 'System',
      actualTools: 'Tools Used',
      ...
      responseTextTruncated: 'Response Text Truncated',
      truncated: 'Truncated',
      tools: 'Tools',
