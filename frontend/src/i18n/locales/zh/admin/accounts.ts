export default {
    accounts: {
        ...
        bulkDeleteGroupNoAccounts: "分组 {name} 没有账号",
        bulkDeleteGroupPartial: "分组 {name}：成功 {success}，失败 {failed}",
        bulkDeleteGroupPrompt: "即将删除 {name} 的全部 {count} 个账号，请输入分组名称确认",
        bulkDeleteGroupSelectRequired: "请先选择分组",
        bulkDeleteGroupSuccess: "已删除 {name} 的 {count} 个账号",
